...
public class QueryPagePayMainRespDTOExcel implements Serializable {
	...
	private PageResult<PayMainExcel> resultData;
	 ...
	 */
	public PageResult<PayMainExcel> getResultData() {
		return resultData;
	}
	 ...
	 */
	public void setResultData(PageResult<PayMainExcel> resultData) {
